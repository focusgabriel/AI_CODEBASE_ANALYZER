...
// import { getAnalysisFile } from "../services/files.services";
...
//    const [fileResponse, metricsResponse] = useState([])
...
//       const response = await getAnalysisFile(analysisId, file.fileId)
