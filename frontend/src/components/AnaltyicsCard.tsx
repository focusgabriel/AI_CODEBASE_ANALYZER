  ...
  return (
    <div className="group w-full bg-white px-4 py-3 transition-colors duration-150 hover:bg-slate-50/70">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-12 sm:items-center sm:gap-3">
        {/* Title column — full row on mobile, col-span-4 on sm+ */}
        <div className="flex items-center justify-between gap-2.5 sm:col-span-4">
          <Link
            to={onClick}
          ...
          {/* Actions — shown inline on mobile only */}
        ...
        {/* Status column */}
        <Link to={onClick} className="flex min-w-0 sm:col-span-2">
          <div
        ...
        {/* Date column */}
        <Link to={onClick} className="min-w-0 sm:col-span-3">
          <p className="min-w-0 truncate text-[11px] text-gray-500">{date}</p>
        </Link>

        {/* Score column */}
        <Link to={onClick} className="min-w-0 sm:col-span-2">
          <div className="flex shrink-0 items-center">{score}</div>
        </Link>

        {/* Actions column — desktop only (mobile shows actions in title row) */}
        <div className="hidden min-w-0 items-center justify-end sm:col-span-1 sm:flex">
