...
const AnalyticsPage = ({ getAnalysis, scoreTrend }: AnalysisData) => {
  ...
  //   (Uploads ?? []).map(item => [item.analysisId, item.originalFileName]),
  // );
      ...
      <div className="flex-1 space-y-1 overflow-y-auto pr-1">
        {reportData.length === 0 ? (
          ...
          reportData.map(item => {
            ...
            // const originalName = projectPath.get(item._id) ?? "";
